...
![custom url for public dashboard](/images/docs/dashboards/custom_url.png)
...
![custom domain for public dashboard](/images/docs/dashboards/custom_domain.png)
...
![add cname to DNS provider](/images/docs/dashboards/aws_cname.png)
