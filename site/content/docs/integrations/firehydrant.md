...
![firehydrant integration step 1](/images/docs/integrations/firehydrant/firehydrant_step1.png)

2. Next, copy the generated URL to your clipboard.

![firehydrant integration step 2](/images/docs/integrations/firehydrant/firehydrant_step2.png)
...
![firehydrant integration step 3](/images/docs/integrations/firehydrant/firehydrant_step3.png)
...
![firehydrant integration step 4](/images/docs/integrations/firehydrant/firehydrant_step4.png)

You are all set! Now, when a check fails, you will see an alert in your configured Slack channel:

![firehydrant integration step 5](/images/docs/integrations/firehydrant/firehydrant_step5.png)
...
![firehydrant integration step 6](/images/docs/integrations/firehydrant/firehydrant_step6.png)
