...
- `resource-type:id`: Imports only the specified resource. E.g `npx checkly import alert-channel:b03985ce-baf4-46e4-8bcd-36a463353d6a`. Resource types are: `check`|`check-group`|`alert-channel`|`maintenance-window`|`private-location`|`dashboard`|`snippet`|`status-page`|`status-page-service`.
